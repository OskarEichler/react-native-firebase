 ...
 * no upsert. Use {@link #putIfAbsent} (first wins) or {@link #putReplacing} (last wins) for atomic
 * upsert. Replace at the call site with {@code take} then {@code put} only when neither helper
 * fits.
 *
